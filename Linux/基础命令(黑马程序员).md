...
![image-20241006211354265](https://raw.githubusercontent.com/ZhangZhen-huia/Note/main/img/202410062113474.png)

语法：`chmod [-R] 权限 参数`

- 权限，要设置的权限，,不建议使用u=?,g=?,o=?的写法，而是使用二进制表示，比如755，表示：`rwxr-xr-x`
...
**注意：若是创建后用ls并不能查看到目录，那就在命令后面加上 -m**
